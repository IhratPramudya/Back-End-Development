...
class AuthenticationsHandler {
  constructor(service, validator) {
    ...
    this.postAuthenticationsLoginHandler =
      this.postAuthenticationsLoginHandler.bind(this);
    this.putAuthenticationsRefreshTokenHandler =
      this.putAuthenticationsRefreshTokenHandler.bind(this);
